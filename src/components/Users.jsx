    ...
    <Fragment>
      ...
      <div>
        ...
        <p>
          ...
          <strong> {energyConsuption.mb_rate} calories</strong> et votre{' '}
          <u>dépense énergétique journalière</u> est de
          <strong>{energyConsuption.daily_energy} calories</strong>
        </p>
        <p>
          Vous devez consommer idéalement
          <ul>
            <li href="#simple-list">- {PLG.proteins} grammes de protéines</li>
            <li href="#simple-list">- {PLG.lipids} grammes de lipides</li>
            <li href="#simple-list">- {PLG.glucids} grammes de glucides</li>
          </ul>
        </p>
        <hr />
